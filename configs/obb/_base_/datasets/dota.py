...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        task='Task1',
        ann_file=data_root + 'mydotatrain/annfiles/',
        img_prefix=data_root + 'mydotatrain/images/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        task='Task1',
        ann_file=data_root + 'mydotaval/annfiles/',
        img_prefix=data_root + 'mydotaval/images/',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        task='Task1',
        ann_file=data_root + 'mydotatest/annfiles/',
        img_prefix=data_root + 'mydotatest/images/',
        pipeline=test_pipeline))
evaluation = dict(interval=2,metric='mAP')
